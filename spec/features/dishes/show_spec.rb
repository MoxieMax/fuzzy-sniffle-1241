...
RSpec.describe 'Dishes Show Page', type: :feature do
  ...
  let!(:dish_ingredient1) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient1.id)
  let!(:dish_ingredient2) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient2.id)
  let!(:dish_ingredient3) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient3.id)
  let!(:dish_ingredient4) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient4.id)
  let!(:dish_ingredient5) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient5.id)
  let!(:dish_ingredient6) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient6.id)
  let!(:dish_ingredient7) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient7.id)
  let!(:dish_ingredient8) {DishIngredient.create!(dish_id: dish.id, ingredients_id: ingredient8.id)
